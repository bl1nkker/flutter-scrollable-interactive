    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Add a Container, 400 points tall, and set the background color
          //to grey. This container will hold your horizontal list view.
          Container(
            height: 400,
            // Change the color from grey to transparent.
            color: Colors.transparent,
            // Create ListView.separated. Remember, this widget creates
            //two IndexedWidgetBuilders.
            child: ListView.separated(
              ...
              separatorBuilder: (context, index) {
                // For every item, you create a SizedBox to space every item
                //16 points apart.
