...
class GroceryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //presents the screen to create or add an item. You’ll build this screen
      //later.
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          Navigator.push(
            context,
            // MaterialPageRoute replaces the entire screen with
            //a platform-specific transition. In Android, for example, it slides
  ...
  Widget buildGroceryScreen() {
    // You wrap your widgets inside a Consumer,
